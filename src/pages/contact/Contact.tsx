                        ...
                        <form
                            ...
                            {submitted ? (
                                <motion.div
                                    ...
                                    animate={{ opacity: 1, y: 0 }}
                                    exit={{ opacity: 0 }}
                                    className="flex flex-row justify-center items-center gap-2 text-green-400 font-medium text-sm mt-2">
                                ...
                                <div className="flex flex-col items-center space-y-3">
                                    ...
                                    <div className="flex flex-row justify-evenly xl:justify-between w-full">
                                        <div className="content-center">
                                            <Mail className="w-6 h-6 text-orange-400 align-text-bottom" />
                                        </div>
